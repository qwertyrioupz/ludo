...
const VerticalPath = memo(({ cells, color }: VerticalPathProps) => {
  ...
  return (
    <div className="flex h-full w-[20%] items-center justify-center overflow-hidden">
...
VerticalPath.displayName = "VerticalPath"
